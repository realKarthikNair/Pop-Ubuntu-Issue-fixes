...
##### **24 Pop!_Shop simply doesn't open sometimes**
...
##### **25 DNS issue due to messed up VPN configs. No internet. DNS_PROBE_FINISHED_BAD_CONFIG**
...
##### **26. `sudo: unable to resolve host $HOSTNAME`**
